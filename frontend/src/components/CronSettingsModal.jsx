...
function CronSettingsModal({ onClose, currentCron, fetchStudents, refreshCronTime }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm bg-gradient-to-br from-pink-50 to-yellow-50/80 z-50">
            ...
            <motion.div
                ...
                className="bg-white border border-pink-200 p-8 rounded-2xl shadow-2xl w-full max-w-md relative"
            >
                <button
                    onClick={onClose}
                ...
                <h2 className="text-2xl font-bold text-pink-600 mb-6">Update Cron Time</h2>

                <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <label className="block mb-1 font-medium text-pink-700">Minute</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            pattern="[0-9*]*"
                            className="w-full border border-pink-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-400 transition"
                            value={minute}
                    ...
                    <div>
                        <label className="block mb-1 font-medium text-pink-700">Hour</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            pattern="[0-9*]*"
                    ...
                    <div>
                        <label className="block mb-1 font-medium text-pink-700">Day of Month</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            pattern="[0-9*]*"
                    ...
                    <div>
                        <label className="block mb-1 font-medium text-pink-700">Month</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            pattern="[0-9*]*"
                    ...
                    <div>
                        <label className="block mb-1 font-medium text-pink-700">Day of Week</label>
                        <input
                            type="text"
                            inputMode="numeric"
                            pattern="[0-9*]*"
                ...
                <div className="mb-4 flex flex-wrap gap-2">
                    <button
                        ...
                        className="bg-gradient-to-r from-pink-100 to-yellow-100 hover:from-pink-200 hover:to-yellow-200 text-pink-700 px-3 py-1 rounded-lg transition"
                    >
                        Every Day
                    </button>
                    <button
                ...
                <div className="flex justify-end gap-4 pt-2">
                    <button
                        ...
                        className="bg-gradient-to-r from-pink-500 to-yellow-500 hover:from-pink-600 hover:to-yellow-600 text-white px-5 py-2 rounded-lg shadow transition"
                    >
                        Update
                    </button>
                    <button
                        onClick={onClose}
                        className="bg-yellow-100 hover:bg-yellow-200 text-yellow-700 px-5 py-2 rounded-lg transition"
                    >
                        Cancel
                    </button>
                </div>
