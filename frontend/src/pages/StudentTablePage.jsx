...
function StudentTablePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-green-50 p-4 md:p-8 flex flex-col items-center">
            ...
            {loading && (
                ...
                <div className="w-full max-w-7xl">
                    <h1 className="text-4xl font-bold text-center text-pink-500 mb-8 tracking-tight">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-3">
                        <div className="flex gap-2 flex-wrap">
                            <button
                                ...
                                className="bg-gradient-to-r from-pink-400 to-yellow-400 hover:from-pink-500 hover:to-yellow-500 text-white px-4 py-2 rounded-lg shadow transition font-semibold"
                            >
                                <Plus size={18} />
                            ...
                            <button
                                ...
                                className="bg-gradient-to-r from-blue-400 to-green-400 hover:from-blue-500 hover:to-green-500 text-white px-4 py-2 rounded-lg shadow transition font-semibold"
                            >
                                <Download size={18} />
                            ...
                            <button
                                ...
                                className="bg-gradient-to-r from-yellow-400 to-pink-400 hover:from-yellow-500 hover:to-pink-500 text-white px-4 py-2 rounded-lg shadow transition font-semibold"
                            >
                        ...
                        <div className="text-sm text-gray-700 mt-2 md:mt-0">
                            ...
                            <span className="ml-2 px-2 py-1 bg-yellow-100 rounded text-pink-700 font-mono">
                    ...
                    <div className="overflow-x-auto rounded-xl shadow bg-white">
                        <table className="min-w-full text-sm md:text-base table-fixed">
                            <thead className="bg-pink-100">
                                <tr>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Name</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Email</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Phone</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">CF Handle</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Current Rating</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Max Rating</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Last Updated</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Reminders Sent</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Auto Reminder</th>
                                    <th className="py-3 px-4 font-semibold text-pink-700">Actions</th>
                                </tr>
                            </thead>
                            <tbody>
                                {students.map(student => (
                                    ...
                                    >
                                        ...
                                        <td className="py-2 px-4 border-b">
                                            <span className={`font-mono px-2 py-1 rounded ${getRatingColor(student.currentRating)}`}>
                                                {student.cfHandle}
                                            </span>
                                        </td>
                                        <td className="py-2 px-4 border-b">{student.currentRating}</td>
                                        <td className="py-2 px-4 border-b">{student.maxRating}</td>
                                        <td className="py-2 px-4 border-b">{new Date(student.lastUpdated).toLocaleString()}</td>
                                        ...
                                        <td className="py-2 px-4 border-b" onClick={e => e.stopPropagation()}>
                                            <button
                                                ...
                                                className={`px-3 py-1 rounded-full font-semibold shadow transition ${
